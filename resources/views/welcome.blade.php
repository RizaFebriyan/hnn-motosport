        ...
        <div
            ...
            <div class="max-w-3xl">
                ...
                <div
                    ...
                    Premium Bigbike Dealer di Jakarta
                </div>

                <h1 class="text-5xl md:text-7xl font-black text-white uppercase tracking-tighter leading-[1.1] mb-6">
                    The Beauty & <br>
                    <span
                        class="text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-red-800 drop-shadow-[0_0_10px_rgba(220,38,38,0.5)]">
                        The Beast
                    </span>
                </h1>

                <p class="text-gray-400 text-lg md:text-xl mb-10 border-l-4 border-red-600 pl-4 max-w-2xl font-light">
                    Pilihan kendaraan motor CBU Super Lengkap. Kami memberi Anda pengetahuan yang dibutuhkan untuk membuat
                    keputusan cerdas dalam memilih kendaraan yang tepat untuk gaya hidup Anda.
                </p>

                <div class="flex flex-wrap items-center gap-4">
                    <a href="/stok-motor"
                        class="px-8 py-4 bg-red-600 text-white font-bold uppercase text-sm tracking-wider hover:bg-white hover:text-red-600 transition duration-300 shadow-[0_0_20px_rgba(220,38,38,0.3)] hover:shadow-[0_0_20px_rgba(255,255,255,0.5)]">
                        Lihat Koleksi Kami
                    </a>
                    <a href="/jual-kendaraan"
                        class="px-8 py-4 bg-transparent border border-gray-600 text-gray-300 font-bold uppercase text-sm tracking-wider hover:border-red-600 hover:text-white transition duration-300">
                        Jual Kendaraan Anda
                    </a>
                </div>
